...
export PROFILE_NAME="Boo Shnickle Light"

export COLOR_01="#FFFFCC"           # Black (Host)
...
export COLOR_08="#5B5B49"           # White

export COLOR_09="#9C9C7D"           # Bright Black
...
export COLOR_16="#191914"           # Bright White

export BACKGROUND_COLOR="#FFFFCC"   # Background
export FOREGROUND_COLOR="#5B5B49"   # Foreground (Text)

export CURSOR_COLOR="#5B5B49" # Cursor
