...
export PROFILE_NAME="Zenbones Light"

export COLOR_01="#F0EDEC"           # Black (Host)
...
export COLOR_08="#2C363C"           # White

export COLOR_09="#CFC1BA"           # Bright Black
...
export COLOR_16="#4F5E68"           # Bright White

export BACKGROUND_COLOR="#F0EDEC"   # Background
export FOREGROUND_COLOR="#2C363C"   # Foreground (Text)

export CURSOR_COLOR="#2C363C" # Cursor
