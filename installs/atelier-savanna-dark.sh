...
export PROFILE_NAME="Atelier Savanna Dark"
...
export COLOR_11="#232A25"           # Bright Green (Exec)
export COLOR_12="#526057"           # Bright Yellow
export COLOR_13="#78877D"           # Bright Blue (Folder)
export COLOR_14="#DFE7E2"           # Bright Magenta
export COLOR_15="#867469"           # Bright Cyan
export COLOR_16="#ECF4EE"           # Bright White

export BACKGROUND_COLOR="#171C19"   # Background
export FOREGROUND_COLOR="#87928A"   # Foreground (Text)

export CURSOR_COLOR="#87928A" # Cursor
