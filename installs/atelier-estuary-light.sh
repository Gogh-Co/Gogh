...
export PROFILE_NAME="Atelier Estuary Light"

export COLOR_01="#F4F3EC"           # Black (Host)
...
export COLOR_08="#5F5E4E"           # White

export COLOR_09="#878573"           # Bright Black
export COLOR_10="#BA6236"           # Bright Red (Command error)
...
export COLOR_16="#22221B"           # Bright White

export BACKGROUND_COLOR="#F4F3EC"   # Background
export FOREGROUND_COLOR="#5F5E4E"   # Foreground (Text)

export CURSOR_COLOR="#5F5E4E" # Cursor
