...
export PROFILE_NAME="Farmhouse Dark"

export COLOR_01="#1D2027"           # Black (Host)
export COLOR_02="#BA0004"           # Red (Syntax string)
export COLOR_03="#549D00"           # Green (Command)
export COLOR_04="#C87300"           # Yellow (Command second)
export COLOR_05="#0049E6"           # Blue (Path)
export COLOR_06="#9F1B61"           # Magenta (Syntax var)
export COLOR_07="#1FB65C"           # Cyan (Prompt)
...
export BACKGROUND_COLOR="#1D2027"   # Background
export FOREGROUND_COLOR="#E8E4E1"   # Foreground (Text)
