...
export PROFILE_NAME="Black Metal (Bathory)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#FBCB97"           # Green (Command)
export COLOR_04="#E78A53"           # Yellow (Command second)
...
export COLOR_11="#FBCB97"           # Bright Green (Exec)
export COLOR_12="#E78A53"           # Bright Yellow
