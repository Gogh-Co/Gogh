...
export PROFILE_NAME="Embers Dark"
...
export COLOR_10="#828257"           # Bright Red (Command error)
export COLOR_11="#2C2620"           # Bright Green (Exec)
export COLOR_12="#433B32"           # Bright Yellow
export COLOR_13="#8A8075"           # Bright Blue (Folder)
export COLOR_14="#BEB6AE"           # Bright Magenta
export COLOR_15="#825757"           # Bright Cyan
