...
export PROFILE_NAME="GitHub Dark Colorblind"

export COLOR_01="#484F58"           # Black (Host)
export COLOR_02="#EC8E2C"           # Red (Syntax string)
...
export COLOR_10="#FDAC54"           # Bright Red (Command error)
...
export CURSOR_COLOR="#58A6FF" # Cursor
