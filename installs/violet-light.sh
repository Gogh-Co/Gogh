...
export PROFILE_NAME="Violet Light"
...
export BACKGROUND_COLOR="#FCF4DC"   # Background
export FOREGROUND_COLOR="#536870"   # Foreground (Text)

export CURSOR_COLOR="#536870" # Cursor
