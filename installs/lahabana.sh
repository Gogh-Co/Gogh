...
export PROFILE_NAME="Lahabana"

export COLOR_01="#19191A"           # Black (Host)
export COLOR_02="#FC618D"           # Red (Syntax string)
export COLOR_03="#7BD88F"           # Green (Command)
export COLOR_04="#E5FF9D"           # Yellow (Command second)
...
export BACKGROUND_COLOR="#19191A"   # Background
