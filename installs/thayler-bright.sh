...
export PROFILE_NAME="Thayler Bright"

export COLOR_01="#1B1D1E"           # Black (Host)
export COLOR_02="#F92672"           # Red (Syntax string)
export COLOR_03="#4DF740"           # Green (Command)
export COLOR_04="#3F78FF"           # Yellow (Command second)
export COLOR_05="#2656D6"           # Blue (Path)
export COLOR_06="#8C54FE"           # Magenta (Syntax var)
export COLOR_07="#37C8B4"           # Cyan (Prompt)
...
export COLOR_15="#23CED4"           # Bright Cyan
export COLOR_16="#F8F8F2"           # Bright White

export BACKGROUND_COLOR="#1B1D1E"   # Background
export FOREGROUND_COLOR="#ADADA9"   # Foreground (Text)

export CURSOR_COLOR="#ADADA9" # Cursor
