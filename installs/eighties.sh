...
export COLOR_08="#D3D0C8"           # White

export COLOR_09="#747369"           # Bright Black
...
export COLOR_16="#F2F0EC"           # Bright White

export BACKGROUND_COLOR="#2D2D2D"   # Background
export FOREGROUND_COLOR="#D3D0C8"   # Foreground (Text)

export CURSOR_COLOR="#D3D0C8" # Cursor
