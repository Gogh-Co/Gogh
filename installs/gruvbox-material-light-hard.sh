...
export PROFILE_NAME="Gruvbox Material Light Hard"

export COLOR_01="#F9F5D7"           # Black (Host)
...
export COLOR_09="#A89984"           # Bright Black
...
export BACKGROUND_COLOR="#F9F5D7"   # Background
