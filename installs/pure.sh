...
export PROFILE_NAME="Pure"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#FF4060"           # Red (Syntax string)
export COLOR_03="#55A12D"           # Green (Command)
export COLOR_04="#FFD7B1"           # Yellow (Command second)
export COLOR_05="#80BBFF"           # Blue (Path)
...
export COLOR_10="#FF4060"           # Bright Red (Command error)
