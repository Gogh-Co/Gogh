...
export PROFILE_NAME="Everforest Light Hard"

export COLOR_01="#7A8478"           # Black (Host)
...
export COLOR_08="#F2EFDF"           # White

export COLOR_09="#A6B0A0"           # Bright Black
...
export COLOR_16="#FFFBEF"           # Bright White

export BACKGROUND_COLOR="#F2EFDF"   # Background
export FOREGROUND_COLOR="#5C6A72"   # Foreground (Text)

export CURSOR_COLOR="#F57D26" # Cursor
