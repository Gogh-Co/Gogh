...
export PROFILE_NAME="Black Metal (Mayhem)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#F3ECD4"           # Green (Command)
export COLOR_04="#EECC6C"           # Yellow (Command second)
...
export COLOR_11="#F3ECD4"           # Bright Green (Exec)
export COLOR_12="#EECC6C"           # Bright Yellow
