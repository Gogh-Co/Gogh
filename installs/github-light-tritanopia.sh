...
export PROFILE_NAME="Github Light Tritanopia"
...
export COLOR_14="#8250DF"           # Bright Magenta
export COLOR_15="#1B7C83"           # Bright Cyan
export COLOR_16="#6E7781"           # Bright White

export BACKGROUND_COLOR="#FFFFFF"   # Background
export FOREGROUND_COLOR="#1B1F24"   # Foreground (Text)

export CURSOR_COLOR="#1B1F24" # Cursor
