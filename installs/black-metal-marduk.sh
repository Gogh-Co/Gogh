...
export PROFILE_NAME="Black Metal (Marduk)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#A5AAA7"           # Green (Command)
export COLOR_04="#626B67"           # Yellow (Command second)
...
export COLOR_11="#A5AAA7"           # Bright Green (Exec)
export COLOR_12="#626B67"           # Bright Yellow
