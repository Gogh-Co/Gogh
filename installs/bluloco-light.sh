...
export COLOR_01="#373A41"           # Black (Host)
...
export COLOR_08="#BABBC2"           # White

export COLOR_09="#676A77"           # Bright Black
...
export FOREGROUND_COLOR="#373A41"   # Foreground (Text)

export CURSOR_COLOR="#F32759" # Cursor
