...
export PROFILE_NAME="Atelier Forest Dark"
...
export COLOR_11="#2C2421"           # Bright Green (Exec)
export COLOR_12="#68615E"           # Bright Yellow
export COLOR_13="#9C9491"           # Bright Blue (Folder)
export COLOR_14="#E6E2E0"           # Bright Magenta
export COLOR_15="#C33FF3"           # Bright Cyan
export COLOR_16="#F1EFEE"           # Bright White

export BACKGROUND_COLOR="#1B1918"   # Background
export FOREGROUND_COLOR="#A8A19F"   # Foreground (Text)

export CURSOR_COLOR="#A8A19F" # Cursor
