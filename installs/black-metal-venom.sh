...
export PROFILE_NAME="Black Metal (Venom)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#F8F7F2"           # Green (Command)
export COLOR_04="#79241F"           # Yellow (Command second)
...
export COLOR_11="#F8F7F2"           # Bright Green (Exec)
export COLOR_12="#79241F"           # Bright Yellow
