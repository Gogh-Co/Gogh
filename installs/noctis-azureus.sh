...
export PROFILE_NAME="Noctis Azureus"

export COLOR_01="#28353E"           # Black (Host)
...
export COLOR_08="#AEC3D0"           # White

export COLOR_09="#475E6C"           # Bright Black
...
export COLOR_16="#BECFDA"           # Bright White

export BACKGROUND_COLOR="#07273B"   # Background
export FOREGROUND_COLOR="#BECFDA"   # Foreground (Text)

export CURSOR_COLOR="#BECFDA" # Cursor
