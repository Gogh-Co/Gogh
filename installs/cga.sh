...
export PROFILE_NAME="CGA"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#AA0000"           # Red (Syntax string)
export COLOR_03="#00AA00"           # Green (Command)
export COLOR_04="#AA5500"           # Yellow (Command second)
export COLOR_05="#0000AA"           # Blue (Path)
export COLOR_06="#AA00AA"           # Magenta (Syntax var)
...
export CURSOR_COLOR="#B8B8B8" # Cursor
