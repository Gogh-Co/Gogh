...
export PROFILE_NAME="Dark Plus"

export COLOR_01="#0E0E0E"           # Black (Host)
export COLOR_02="#CD3131"           # Red (Syntax string)
export COLOR_03="#0DBC79"           # Green (Command)
export COLOR_04="#3B8EEA"           # Yellow (Command second)
...
export BACKGROUND_COLOR="#0E0E0E"   # Background
export FOREGROUND_COLOR="#C5C5C5"   # Foreground (Text)

export CURSOR_COLOR="#C5C5C5" # Cursor
