...
export PROFILE_NAME="Adapta Nokto Maia"

export COLOR_01="#222D31"           # Black (Host)
...
export COLOR_07="#1ABB9B"           # Cyan (Prompt)
...
export COLOR_15="#1ABB9B"           # Bright Cyan
export COLOR_16="#F8F8F8"           # Bright White

export BACKGROUND_COLOR="#222D31"   # Background
