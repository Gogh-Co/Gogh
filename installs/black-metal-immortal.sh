...
export PROFILE_NAME="Black Metal (Immortal)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#7799BB"           # Green (Command)
export COLOR_04="#556677"           # Yellow (Command second)
...
export COLOR_11="#7799BB"           # Bright Green (Exec)
export COLOR_12="#556677"           # Bright Yellow
