...
export PROFILE_NAME="Atelier Cave Dark"
...
export COLOR_11="#26232A"           # Bright Green (Exec)
export COLOR_12="#585260"           # Bright Yellow
export COLOR_13="#7E7887"           # Bright Blue (Folder)
export COLOR_14="#E2DFE7"           # Bright Magenta
export COLOR_15="#BF40BF"           # Bright Cyan
export COLOR_16="#EFECF4"           # Bright White

export BACKGROUND_COLOR="#19171C"   # Background
export FOREGROUND_COLOR="#8B8792"   # Foreground (Text)

export CURSOR_COLOR="#8B8792" # Cursor
