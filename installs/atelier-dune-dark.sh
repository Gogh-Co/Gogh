...
export PROFILE_NAME="Atelier Dune Dark"
...
export COLOR_11="#292824"           # Bright Green (Exec)
export COLOR_12="#6E6B5E"           # Bright Yellow
export COLOR_13="#999580"           # Bright Blue (Folder)
export COLOR_14="#E8E4CF"           # Bright Magenta
export COLOR_15="#D43552"           # Bright Cyan
export COLOR_16="#FEFBEC"           # Bright White

export BACKGROUND_COLOR="#20201D"   # Background
export FOREGROUND_COLOR="#A6A28C"   # Foreground (Text)

export CURSOR_COLOR="#A6A28C" # Cursor
