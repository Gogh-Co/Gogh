...
export PROFILE_NAME="Poimandres Storm"

export COLOR_01="#252B37"           # Black (Host)
...
export COLOR_06="#F087BD"           # Magenta (Syntax var)
...
export COLOR_14="#F087BD"           # Bright Magenta
export COLOR_15="#ADD7FF"           # Bright Cyan
export COLOR_16="#FFFFFF"           # Bright White

export BACKGROUND_COLOR="#252B37"   # Background
