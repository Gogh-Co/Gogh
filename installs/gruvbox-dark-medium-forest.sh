...
export PROFILE_NAME="Gruvbox Dark Medium Forest"
...
export COLOR_05="#B8BB26"           # Blue (Path)
export COLOR_06="#96BDA2"           # Magenta (Syntax var)
export COLOR_07="#5F6C1F"           # Cyan (Prompt)
export COLOR_08="#D5C4A1"           # White

export COLOR_09="#665C50"           # Bright Black
...
export COLOR_13="#B8BB26"           # Bright Blue (Folder)
export COLOR_14="#96BDA2"           # Bright Magenta
export COLOR_15="#5F6C1F"           # Bright Cyan
