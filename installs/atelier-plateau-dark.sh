...
export PROFILE_NAME="Atelier Plateau Dark"
...
export COLOR_11="#292424"           # Bright Green (Exec)
export COLOR_12="#585050"           # Bright Yellow
export COLOR_13="#7E7777"           # Bright Blue (Folder)
export COLOR_14="#E7DFDF"           # Bright Magenta
export COLOR_15="#BD5187"           # Bright Cyan
export COLOR_16="#F4ECEC"           # Bright White

export BACKGROUND_COLOR="#1B1818"   # Background
export FOREGROUND_COLOR="#8A8585"   # Foreground (Text)

export CURSOR_COLOR="#8A8585" # Cursor
