...
export PROFILE_NAME="Remedy Dark"
...
export BACKGROUND_COLOR="#2C2B2A"   # Background
export FOREGROUND_COLOR="#F9E7C4"   # Foreground (Text)

export CURSOR_COLOR="#F9E7C4" # Cursor
