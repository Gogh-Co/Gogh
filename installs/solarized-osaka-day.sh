...
export PROFILE_NAME="Solarized Osaka Day"
...
export BACKGROUND_COLOR="#FDF5E0"   # Background
export FOREGROUND_COLOR="#586E74"   # Foreground (Text)

export CURSOR_COLOR="#586E74" # Cursor
