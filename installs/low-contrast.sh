...
export PROFILE_NAME="Low Contrast"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#BB0000"           # Red (Syntax string)
export COLOR_03="#00BB00"           # Green (Command)
export COLOR_04="#BBBB00"           # Yellow (Command second)
export COLOR_05="#0000BB"           # Blue (Path)
...
export COLOR_12="#BBBB00"           # Bright Yellow
export COLOR_13="#0000BB"           # Bright Blue (Folder)
export COLOR_14="#BB00BB"           # Bright Magenta
export COLOR_15="#00BBBB"           # Bright Cyan
export COLOR_16="#BBBBBB"           # Bright White
