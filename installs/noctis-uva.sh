...
export PROFILE_NAME="Noctis Uva"

export COLOR_01="#302F3D"           # Black (Host)
...
export COLOR_08="#B6B3CC"           # White

export COLOR_09="#504E65"           # Bright Black
...
export COLOR_16="#C5C2D6"           # Bright White

export BACKGROUND_COLOR="#292640"   # Background
export FOREGROUND_COLOR="#C5C2D6"   # Foreground (Text)

export CURSOR_COLOR="#C5C2D6" # Cursor
