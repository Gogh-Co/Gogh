...
export PROFILE_NAME="Tokyo Night Enhanced"

export COLOR_01="#363B54"           # Black (Host)
...
export COLOR_09="#363B54"           # Bright Black
...
export COLOR_16="#787C99"           # Bright White

export BACKGROUND_COLOR="#08080B"   # Background
