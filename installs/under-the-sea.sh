...
export PROFILE_NAME="Under The Sea"

export COLOR_01="#022026"           # Black (Host)
export COLOR_02="#B2302D"           # Red (Syntax string)
export COLOR_03="#00A941"           # Green (Command)
export COLOR_04="#59819C"           # Yellow (Command second)
export COLOR_05="#459A86"           # Blue (Path)
...
export BACKGROUND_COLOR="#011116"   # Background
export FOREGROUND_COLOR="#FFFFFF"   # Foreground (Text)

export CURSOR_COLOR="#4AFCD6" # Cursor
