...
export PROFILE_NAME="Tokyo Night Terminal Light"

export COLOR_01="#D5D6DB"           # Black (Host)
...
export COLOR_16="#1A1B26"           # Bright White

export BACKGROUND_COLOR="#D5D6DB"   # Background
export FOREGROUND_COLOR="#4C505E"   # Foreground (Text)

export CURSOR_COLOR="#4C505E" # Cursor
