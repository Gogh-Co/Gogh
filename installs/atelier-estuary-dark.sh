...
export PROFILE_NAME="Atelier Estuary Dark"
...
export COLOR_11="#302F27"           # Bright Green (Exec)
export COLOR_12="#5F5E4E"           # Bright Yellow
export COLOR_13="#878573"           # Bright Blue (Folder)
export COLOR_14="#E7E6DF"           # Bright Magenta
export COLOR_15="#9D6C7C"           # Bright Cyan
export COLOR_16="#F4F3EC"           # Bright White

export BACKGROUND_COLOR="#22221B"   # Background
export FOREGROUND_COLOR="#929181"   # Foreground (Text)

export CURSOR_COLOR="#929181" # Cursor
