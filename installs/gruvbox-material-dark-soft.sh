...
export PROFILE_NAME="Gruvbox Material Dark Soft"

export COLOR_01="#32302F"           # Black (Host)
...
export COLOR_09="#7C6F64"           # Bright Black
...
export BACKGROUND_COLOR="#32302F"   # Background
