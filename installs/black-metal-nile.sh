...
export PROFILE_NAME="Black Metal (Nile)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#AA9988"           # Green (Command)
export COLOR_04="#777755"           # Yellow (Command second)
...
export COLOR_11="#AA9988"           # Bright Green (Exec)
export COLOR_12="#777755"           # Bright Yellow
