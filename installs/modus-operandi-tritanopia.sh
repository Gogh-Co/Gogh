...
export PROFILE_NAME="Modus Operandi Tritanopia"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#A60000"           # Red (Syntax string)
export COLOR_03="#006800"           # Green (Command)
export COLOR_04="#695500"           # Yellow (Command second)
...
export COLOR_10="#B21100"           # Bright Red (Command error)
export COLOR_11="#00663F"           # Bright Green (Exec)
export COLOR_12="#973300"           # Bright Yellow
