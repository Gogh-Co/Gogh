...
export PROFILE_NAME="Noctis Obscuro"

export COLOR_01="#324A4D"           # Black (Host)
...
export COLOR_08="#B2CACD"           # White

export COLOR_09="#47686C"           # Bright Black
...
export COLOR_16="#C1D4D7"           # Bright White

export BACKGROUND_COLOR="#031417"   # Background
export FOREGROUND_COLOR="#B2CACD"   # Foreground (Text)

export CURSOR_COLOR="#B2CACD" # Cursor
