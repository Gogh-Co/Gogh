...
export PROFILE_NAME="Kanso Ink"

export COLOR_01="#14171D"           # Black (Host)
...
export COLOR_09="#A4A7A4"           # Bright Black
...
export COLOR_16="#C5C9C7"           # Bright White

export BACKGROUND_COLOR="#14171D"   # Background
export FOREGROUND_COLOR="#C5C9C7"   # Foreground (Text)

export CURSOR_COLOR="#C5C9C7" # Cursor
