...
export PROFILE_NAME="Black Metal (Gorgoroth)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#9B8D7F"           # Green (Command)
export COLOR_04="#8C7F70"           # Yellow (Command second)
...
export COLOR_11="#9B8D7F"           # Bright Green (Exec)
export COLOR_12="#8C7F70"           # Bright Yellow
