...
export PROFILE_NAME="Apple Classic"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#C91B00"           # Red (Syntax string)
export COLOR_03="#00C200"           # Green (Command)
export COLOR_04="#C7C400"           # Yellow (Command second)
export COLOR_05="#0225C7"           # Blue (Path)
...
export BACKGROUND_COLOR="#2C2B2B"   # Background
export FOREGROUND_COLOR="#D5A200"   # Foreground (Text)
