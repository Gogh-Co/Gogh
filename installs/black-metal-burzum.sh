...
export PROFILE_NAME="Black Metal (Burzum)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#DDEECC"           # Green (Command)
export COLOR_04="#99BBAA"           # Yellow (Command second)
...
export COLOR_11="#DDEECC"           # Bright Green (Exec)
export COLOR_12="#99BBAA"           # Bright Yellow
