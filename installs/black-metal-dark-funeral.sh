...
export PROFILE_NAME="Black Metal (Dark Funeral)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#D0DFEE"           # Green (Command)
export COLOR_04="#5F81A5"           # Yellow (Command second)
...
export COLOR_10="#5F8787"           # Bright Red (Command error)
export COLOR_11="#D0DFEE"           # Bright Green (Exec)
export COLOR_12="#5F81A5"           # Bright Yellow
