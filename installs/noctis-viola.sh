...
export PROFILE_NAME="Noctis Viola"

export COLOR_01="#362F3D"           # Black (Host)
...
export COLOR_08="#BFAFCF"           # White

export COLOR_09="#594E65"           # Bright Black
...
export COLOR_16="#CCBFD9"           # Bright White

export BACKGROUND_COLOR="#30243D"   # Background
export FOREGROUND_COLOR="#CCBFD9"   # Foreground (Text)

export CURSOR_COLOR="#CCBFD9" # Cursor
