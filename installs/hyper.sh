...
export PROFILE_NAME="Hyper"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#FE0100"           # Red (Syntax string)
export COLOR_03="#33FF00"           # Green (Command)
export COLOR_04="#FEFF00"           # Yellow (Command second)
...
export COLOR_10="#FE0100"           # Bright Red (Command error)
export COLOR_11="#33FF00"           # Bright Green (Exec)
export COLOR_12="#FEFF00"           # Bright Yellow
