...
export PROFILE_NAME="Grayscale Light"

export COLOR_01="#F7F7F7"           # Black (Host)
...
export COLOR_16="#101010"           # Bright White

export BACKGROUND_COLOR="#F7F7F7"   # Background
export FOREGROUND_COLOR="#464646"   # Foreground (Text)

export CURSOR_COLOR="#464646" # Cursor
