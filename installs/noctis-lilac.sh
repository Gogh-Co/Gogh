...
export PROFILE_NAME="Noctis Lilac"

export COLOR_01="#0C006B"           # Black (Host)
...
export COLOR_09="#0F0080"           # Bright Black
...
export BACKGROUND_COLOR="#F2F1F8"   # Background
export FOREGROUND_COLOR="#0C006B"   # Foreground (Text)

export CURSOR_COLOR="#0C006B" # Cursor
