...
export PROFILE_NAME="Atelier Seaside Dark"
...
export COLOR_11="#242924"           # Bright Green (Exec)
export COLOR_12="#5E6E5E"           # Bright Yellow
export COLOR_13="#809980"           # Bright Blue (Folder)
export COLOR_14="#CFE8CF"           # Bright Magenta
export COLOR_15="#E619C3"           # Bright Cyan
export COLOR_16="#F4FBF4"           # Bright White

export BACKGROUND_COLOR="#131513"   # Background
export FOREGROUND_COLOR="#8CA68C"   # Foreground (Text)

export CURSOR_COLOR="#8CA68C" # Cursor
