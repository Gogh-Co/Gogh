...
export COLOR_07="#FFFF00"           # Cyan (Prompt)
export COLOR_08="#FFFF00"           # White

export COLOR_09="#FFFF00"           # Bright Black
...
export BACKGROUND_COLOR="#E8841D"   # Background
