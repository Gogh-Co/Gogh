...
export PROFILE_NAME="Sandstone Warm"

export COLOR_01="#2E2010"           # Black (Host)
...
export COLOR_06="#B52D6E"           # Magenta (Syntax var)
export COLOR_07="#037A71"           # Cyan (Prompt)
export COLOR_08="#756C51"           # White

export COLOR_09="#5C4A2A"           # Bright Black
export COLOR_10="#C04010"           # Bright Red (Command error)
export COLOR_11="#7F6648"           # Bright Green (Exec)
export COLOR_12="#7D6646"           # Bright Yellow
...
export FOREGROUND_COLOR="#3E3220"   # Foreground (Text)

export CURSOR_COLOR="#3E3220" # Cursor
