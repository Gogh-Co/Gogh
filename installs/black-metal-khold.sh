...
export PROFILE_NAME="Black Metal (Khold)"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#5F8787"           # Red (Syntax string)
export COLOR_03="#ECEEE3"           # Green (Command)
export COLOR_04="#974B46"           # Yellow (Command second)
...
export COLOR_11="#ECEEE3"           # Bright Green (Exec)
export COLOR_12="#974B46"           # Bright Yellow
