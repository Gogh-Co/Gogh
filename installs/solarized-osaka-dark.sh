...
export PROFILE_NAME="Solarized Osaka Dark"

export COLOR_01="#001014"           # Black (Host)
...
export COLOR_08="#839395"           # White

export COLOR_09="#576D74"           # Bright Black
...
export COLOR_16="#839395"           # Bright White

export BACKGROUND_COLOR="#001419"   # Background
export FOREGROUND_COLOR="#839395"   # Foreground (Text)

export CURSOR_COLOR="#839395" # Cursor
