...
export PROFILE_NAME="SeedFlip Phosphor"

export COLOR_01="#070707"           # Black (Host)
...
export FOREGROUND_COLOR="#B3FFB3"   # Foreground (Text)

export CURSOR_COLOR="#00FF88" # Cursor
