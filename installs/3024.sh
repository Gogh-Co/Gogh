...
export COLOR_10="#DB2D20"           # Bright Red (Command error)
export COLOR_11="#01A252"           # Bright Green (Exec)
export COLOR_12="#FDED02"           # Bright Yellow
export COLOR_13="#01A0E4"           # Bright Blue (Folder)
export COLOR_14="#A16A94"           # Bright Magenta
export COLOR_15="#B5E4F4"           # Bright Cyan
