...
export PROFILE_NAME="Mexico Light"

export COLOR_01="#F8F8F8"           # Black (Host)
export COLOR_02="#AB4642"           # Red (Syntax string)
export COLOR_03="#538947"           # Green (Command)
export COLOR_04="#F79A0E"           # Yellow (Command second)
export COLOR_05="#7CAFC2"           # Blue (Path)
export COLOR_06="#96609E"           # Magenta (Syntax var)
export COLOR_07="#4B8093"           # Cyan (Prompt)
export COLOR_08="#383838"           # White

export COLOR_09="#B8B8B8"           # Bright Black
export COLOR_10="#AB4642"           # Bright Red (Command error)
export COLOR_11="#538947"           # Bright Green (Exec)
export COLOR_12="#F79A0E"           # Bright Yellow
export COLOR_13="#7CAFC2"           # Bright Blue (Folder)
export COLOR_14="#96609E"           # Bright Magenta
export COLOR_15="#4B8093"           # Bright Cyan
