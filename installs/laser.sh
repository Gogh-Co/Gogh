...
export COLOR_13="#F92883"           # Bright Blue (Folder)
export COLOR_14="#FFB2FE"           # Bright Magenta
export COLOR_15="#E6E7FE"           # Bright Cyan
export COLOR_16="#FFFFFF"           # Bright White

export BACKGROUND_COLOR="#030D18"   # Background
export FOREGROUND_COLOR="#F106E3"   # Foreground (Text)
