...
export COLOR_08="#E2E2E2"           # White

export COLOR_09="#3F5648"           # Bright Black
...
export BACKGROUND_COLOR="#141E43"   # Background
export FOREGROUND_COLOR="#E1E1E1"   # Foreground (Text)

export CURSOR_COLOR="#43D58E" # Cursor
