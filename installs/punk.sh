...
export COLOR_05="#70A1E0"           # Blue (Path)
...
export COLOR_13="#4C8B8C"           # Bright Blue (Folder)
export COLOR_14="#921E65"           # Bright Magenta
export COLOR_15="#51AAC8"           # Bright Cyan
export COLOR_16="#EEEEEC"           # Bright White

export BACKGROUND_COLOR="#0C031F"   # Background
export FOREGROUND_COLOR="#E9FDFF"   # Foreground (Text)

export CURSOR_COLOR="#E01A4F" # Cursor
