...
export PROFILE_NAME="H Pux"

export COLOR_01="#000000"           # Black (Host)
export COLOR_02="#8C0000"           # Red (Syntax string)
export COLOR_03="#007D00"           # Green (Command)
export COLOR_04="#8C7000"           # Yellow (Command second)
export COLOR_05="#003CB4"           # Blue (Path)
export COLOR_06="#820082"           # Magenta (Syntax var)
...
export BACKGROUND_COLOR="#D1BCA7"   # Background
