...
export COLOR_08="#FFFCF0"           # White

export COLOR_09="#100F0F"           # Bright Black
...
export BACKGROUND_COLOR="#282726"   # Background
export FOREGROUND_COLOR="#FFFCF0"   # Foreground (Text)

export CURSOR_COLOR="#FFFCF0" # Cursor
